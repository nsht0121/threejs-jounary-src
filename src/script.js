...
// Pole light material
const poleLightMaterial = new THREE.MeshBasicMaterial({ color: 0xFFFFE9 })

// Portal light material
debugObject.portalColorStart = '#ffffff'
debugObject.portalColorEnd = '#c0f7ec'
...
gui.addColor(debugObject, 'clearColor').onChange(() => renderer.setClearColor(debugObject.clearColor)).name('clearColor')
